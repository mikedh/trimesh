...
| :warning: WARNING          |
|---------------------------|
| `trimesh >= 4.0.0` makes the minimum Python 3.7 and is in pre-release and will be released soon |
| You can test your stack with: `pip install --pre trimesh` or if you are on older Python you should lock `trimesh<4`|
