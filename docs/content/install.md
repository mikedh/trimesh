...
|`vhacdx`| A binding for VHACD which provides convex decompositions | | `easy`|
|`embreex`| Bindings to Intel's Embree engine for fast ray/mesh intersection queries. | | `easy`|
