...
def test_scene():
    for file_name in ["cycloidal.ply", "sphere.ply"]:
        ...
        for s in [scene_split, scene_base]:
            ...
            assert all(isinstance(L, g.trimesh.scene.lighting.Light) for L in s.lights)
